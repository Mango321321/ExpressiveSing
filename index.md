...
<br>
During the inference stage, the real pitches of audios in the singing corpus are fed into the vibrato labeling model. Then the vibrato likeliness can be predicted by the vibrato labeling model.
